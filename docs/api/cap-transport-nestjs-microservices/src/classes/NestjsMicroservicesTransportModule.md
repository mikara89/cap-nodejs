...
[CAP for NestJS API](../../../README.md) / [cap-transport-nestjs-microservices/src](../README.md) / NestjsMicroservicesTransportModule
...
> **new NestjsMicroservicesTransportModule**(): `NestjsMicroservicesTransportModule`
