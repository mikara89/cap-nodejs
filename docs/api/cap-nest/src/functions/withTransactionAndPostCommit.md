...
Defined in: [cap-nest/src/cap/utils/transaction.util.ts:10](https://github.com/mikara89/cap-nestjs/blob/main/libs/cap-nest/src/cap/utils/transaction.util.ts#L10)
