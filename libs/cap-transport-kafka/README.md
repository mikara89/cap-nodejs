...
while existing groups resume their committed offsets. CAP inbox retry remains authoritative. Messages
with missing/wrong content type, empty values, or invalid JSON are logged,
skipped, and committed once so poison messages cannot loop forever.
